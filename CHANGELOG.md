...
- Expanded HTML stripping regex in WebFetcher to include `<nav>`, `<footer>`, `<iframe>`, and `<noscript>` tags, conserving LLM context tokens and reducing parsing payload size.
