...
## [1.0.26] - 2026-05-05
* **[Optimized]:** Explicitly initialized and warmed up `ConfigManager` in the CLI entry point, using dependency injection to pass the shared instance to `ResearchEngine`. This fulfills the optimization of preventing redundant file system reads across different CLI executions.
